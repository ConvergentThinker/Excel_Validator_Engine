...
public class ExcelUtils {
    ...
    public <T> List<T> retrieveRulesExcelData(Class<T> typeClass, String sourceFile, PoijiOptions...poijiOptionalOpts) {
        ...
        List<T> data = Poiji.fromExcel(new File("/Users/innovative/Documents/Excel Validator/cloned/Excel_Validator_Engine/src/main/resources/Rules.xlsx"), typeClass, opts);
